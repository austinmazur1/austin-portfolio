      ...
      <main className="flex min-h-screen flex-col items-center p-10">
        ...
        <div className="w-full h-screen flex flex-col items-center pt-12">
          ...
          <div className="flex justify-evenly pt-24 items-center">
            ...
            <p className="w-1/2">
              I'm a full-stack developer with experience in React, ExpressJS, NextJS, Tailwind, React Native and Firebase. 
              I am a Long Island New York native but after a few years traveling I eventually settled down in
              Spain.
              <br/>
              <br/>
              I have always
              been an avid learner, eager to soak up as much knowledge as I can
              and get to experimenting and getting creative in any way I can. I
              remember the second I pieced together some HTML and CSS and saw
              the results in my browser I was hooked!
              <br/>
              <br/>
              I
              am a BMX rider, a martial artist, a coffee enthusiast, all outlets
              to express myself. What I love about programming is it scratches
              that same itch. The possibilities are endless and with a bit of
              patience, hard work and eagerness to learn and grow the necessary
              skills, there's no telling what we can build.
            </p>
          </div>
        </div>
        ...
        <div className="w-full h-screen flex flex-col items-center pt-12">
          <p id="contact" className="">Contact</p>
        </div>
      </main>
    </>
  );
