  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-between p-24">
      <div className="z-10 max-w-5xl w-full items-center justify-between font-mono text-sm lg:flex">
        <div className="flex flex-col items-start ">
          <p
            ...
            className="fixed left-0 top-0 text-4xl flex w-full justify-center  pt-8 lg:static lg:w-auto"
          >
            Austin Mazur
          </p>
          <p
            //  className="fixed left-0 top-0 flex w-full justify-center border-b border-gray-300 bg-gradient-to-b from-zinc-200 pb-6 pt-8 backdrop-blur-2xl dark:border-neutral-800 dark:bg-zinc-800/30 dark:from-inherit lg:static lg:w-auto  lg:rounded-xl lg:border lg:bg-gray-200 lg:p-4 lg:dark:bg-zinc-800/30"
            className="fixed left-0 top-0 text-xl flex w-full justify-center pb-6 lg:static lg:w-auto  lg:rounded-xl "
          >
      ...
      <div className="flex -space-x-5 items-start ">
        <div className="w-96 h-60 bg-blue-900 rounded-lg items-center">
          About text goes here
        </div>
        <div className="flex justify-center items-center w-60 h-72 rounded-full border-8 overflow-hidden">
          <Image
